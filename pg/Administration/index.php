...
$res = sql_query("SELECT * FROM `tb_partner` WHERE login_id='".$login_id."' AND login_otp='".$login_otp."' AND type='1' ");
...
<h4 class="text-white text-center">🔐 Administration Login</h4>
